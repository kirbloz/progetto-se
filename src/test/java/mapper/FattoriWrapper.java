...
public class FattoriWrapper {
     ...
     */
    public FattoriWrapper(Map<String, List<FattoreDiConversione>> map) {
        this.fattori = new ArrayList<>();
        for (Map.Entry<String, List<FattoreDiConversione>> entry : map.entrySet()) {
     ...
     */
    public HashMap<String, List<FattoreDiConversione>> toHashMap() {
        HashMap<String, List<FattoreDiConversione>> map = new HashMap<>();
    ...
    public static class Entry {
        ...
        public List<FattoreDiConversione> getValue() {
            return value;
        }
    }
}
